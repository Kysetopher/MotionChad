...
import { type Value, nanoid, NodeApi,TElement, type Descendant } from '@udecode/plate';
...
export const useCommentEditor = (
  ...
  deps: any[] = []
    ...
    const { value: _unusedValue, ...restOptions } = options;
    const commentEditor = useCreateEditor(
        {
            ...
            // Provide a valid initial Slate value (a paragraph node)
            value: [
              {
                type: 'p',
                children: [{ text: '' }],
...
export function CommentCreateForm({
  ...
  const onAddSuggestion = React.useCallback(() => {
    ...
    <div className={cn('flex w-full', className)}>
      ...
      <div className="relative flex grow gap-2">
        ...
        >
            ...
            <EditorContainer variant={"comment" as any}>
             <Editor
              variant={"comment" as any}
